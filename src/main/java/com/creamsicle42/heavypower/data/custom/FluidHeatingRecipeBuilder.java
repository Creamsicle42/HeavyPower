...
public class FluidHeatingRecipeBuilder implements RecipeBuilder {

    private final FluidStack input;
    private final FluidStack output;
    private final int heatPerMb;
    ...
    public FluidHeatingRecipeBuilder(FluidStack input, FluidStack output, int heatPerMb, double temperature) {
        this.input = input;
        this.output = output;
    ...
    public void save(RecipeOutput recipeOutput, @NotNull ResourceLocation id) {
        ...
        FluidHeatingRecipe recipe = new FluidHeatingRecipe(input, output, heatPerMb, temperature);
