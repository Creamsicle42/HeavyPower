...
public class DynamoOutputHatchItem extends Item {
    public DynamoOutputHatchItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (context.getLevel().getBlockEntity(context.getClickedPos()) instanceof SimpleMachinePartBlockEntity simpleMachinePartBlockEntity) {
            ...
            if (controller.tryMakeBlockEnergyOutputHatch(context.getClickedPos())) {
